...
class SaveWEBM:
    ...
    def save_images(
        self, images, codec, fps, filename_prefix, crf, prompt=None, extra_pnginfo=None
    ):
...
class CreateVideo(ComfyNodeABC):
    ...
    def create_video(
        self, images: ImageInput, fps: float, audio: Optional[AudioInput] = None
    ):
        return (
            VideoFromComponents(
                VideoComponents(
