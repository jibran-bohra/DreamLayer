...
def transform_to_txt2img_workflow(data):
    ...
    try:
        ...
        batch_size = max(
            1, min(8, int(data.get("batch_size", 1)))
        ...
        hires_fix_data = {
            ...
            "hires_fix_upscale_method": data.get(
            ...
            "hires_fix_denoising_strength": data.get(
        ...
        use_controlnet = controlnet_data.get("enabled", False) and controlnet_data.get(
            "units"
        )
